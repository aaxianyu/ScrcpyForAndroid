# ScrcpyForAndroid Enhanced — 与上游 v0.5.0 差异对比

> 对比基准：`upstream/main` `b1ba9fc`（v0.5.0，Miuzarte/ScrcpyForAndroid 上游主线）
> 对比目标：`open-source` 分支 HEAD
> 生成日期：2026-07-15
> 说明：以下仅列出**新增/修改的功能**，不包含上游 v0.5.0 已存在的功能
...
| 文件 | 变更 | 说明 |
|------|------|------|
| `services/AppRuntime.kt` | +44/-4 | 新增语言切换处理、USB 连接管理、连接目标标识（设备切换检测） |
